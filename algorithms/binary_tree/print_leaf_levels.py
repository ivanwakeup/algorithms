...
then, build result arrays_and_strings of arrays len(max_depth)
then traverse again postorder, appending leaf lines to their appropriate index in result arrays_and_strings
